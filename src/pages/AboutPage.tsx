      ...
      <Container className="space-y-12">
        <div className="grid gap-6 sm:grid-cols-2">
          {values.map((value) => (
            <div
              key={value.title}
              className="rounded-3xl border border-slate-200 bg-slate-50 p-6 text-sm text-slate-700"
            >
        ...
        <div className="overflow-hidden rounded-[2.5rem] border border-slate-200 bg-gradient-to-r from-blue-50 via-indigo-50 to-slate-50 p-8 sm:p-12">
